          ...
          >
            <div>
              <div className="overlay">
                ...
                <p> If you need help, click on the <i aria-hidden="true" className="question circle outline icon"></i>for assistance. </p>
                ...
                <button className="mini ui button" onClick={this.deactivateModal}>
                  <i className="x icon fitted"></i>
                </button>
              </div>
